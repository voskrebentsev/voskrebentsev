      ...
      <div className='about-block'>
        ...
        <div className='info-block'>
          <p>Welcome, my name is Matvey. I'm at the beginning of my IT career.
            You can see some of my projects on the <Link to='/' className='about-link'>mainpage</Link> and on <a href='github.com/voskrebentsev' className='about-link'>github</a>.
